<template>
  ...
  >
    ...
    <el-table-column prop="stockNo" label="編號" width="150"> </el-table-column>
    <el-table-column prop="tradePrice" label="成交價" width="100"> </el-table-column>
    <el-table-column prop="num" label="股數"> </el-table-column>
    <el-table-column prop="cost" label="成本"> </el-table-column>
    <el-table-column prop="income" label="實現損益 Income(Loss)" width="300"> </el-table-column>
  </el-table>
</template>
